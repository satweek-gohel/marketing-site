...
function ServicePage() {
  ...
  useEffect(() => {
    const fetchData = () => {
      const item = servicesDetails.find((service) => service.id === slug);
      setData(item);
    };
      ...
      <Container>
        <Row>
          <Col md={8}>
            ...
            {/* Skeleton for Expertise */}
            <h2 className={styles.heading}>
              <Skeleton height={30} width={"50%"} />
            </h2>
            <Skeleton height={20} count={3} style={{ marginBottom: "10px" }} />

            {/* Skeleton for Methodology */}
            <h2 className={styles.heading}>
              <Skeleton height={30} width={"50%"} />
            </h2>
  ...
  return (
    <>
      ...
      <Container>
        <Row>
          {/* Left Column: Large Column for Description and Details */}
          <Col md={8}>
            ...
            <div className={styles.menu} data-aos="fade-up">
              <ul>
                ...
                <li
                  ...
                  data-aos="fade-up"
                >
                  <Link href="/products/mobile-app-development">
                ...
                <li
                  ...
                  data-aos="fade-up"
                >
                  <Link href="/products/web-development">
                    Project Management
                  </Link>
                  <GoArrowUpRight className={styles.goicon} />
                </li>
